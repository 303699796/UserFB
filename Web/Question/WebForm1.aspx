<%@ Page Title="" Language="C#" MasterPageFile="~/master/master_1.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="UserFB.Web.Question.WebForm1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <table style="width: 100%;" cellpadding="2" cellspacing="1" class="border">
		...
		<asp:BoundField DataField="time" HeaderText="time" SortExpression="time" ItemStyle-HorizontalAlign="Center"  /> 
               ...
               <table border="0" cellpadding="0" cellspacing="1" style="width: 100%;float:right">
                <tr>
                    <td style="width: 1px;">                        
                    </td>
                    <td align="center">
